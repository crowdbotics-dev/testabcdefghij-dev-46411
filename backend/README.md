...
## Project Structure
    ...
    ├── testabcdefghij_dev_46411  # Django project configurations
...
1. Clone this repo and `cd testabcdefghij_dev_46411`
...
2. Clone this repo and `cd testabcdefghij_dev_46411`
